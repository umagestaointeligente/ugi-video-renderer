...
ITEMS=[
{'id':'CC-ED-20260910-PRADA2','kind':'EDITORIAL','title':'PRADA 2: NOSTALGIA OU EVOLUÇÃO?','beat':'Miranda voltou. Mas a moda mudou.','cta':'Essa continuação precisava existir?','clips':[('prada',10,6),('prada',34,6),('prada',72,6)],'music':'stylish'},
...
{'id':'CC-ED-20260910-ENDGAME','kind':'EDITORIAL','title':'ENDGAME VOLTA À TELA GRANDE','beat':'Alguns filmes viram evento coletivo outra vez.','cta':'Você voltaria ao cinema para rever?','clips':[('endgame',25,6),('endgame',35,6),('endgame',44,6)],'music':'cinematic'},
