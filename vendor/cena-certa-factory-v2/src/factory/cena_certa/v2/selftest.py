...
def run():
 ...
 story=32.12; step=2.66
 cues=[]
 for i,txt in enumerate(chunks):
  start=i*step; cues.append({'text':txt,'start':start,'end':min(start+2.50,31.95)})
 scenes=[]
 ...
 print('FACTORY_V2_SELFTEST_STRESS_PASS',round(elapsed,2),'seconds','story_seconds',story,'caption_chunks',len(chunks))
