...
TOPICS={
 ...
 "rick_acidente":{
  ...
  "scenes":[
   ("REAL",2,"CONTEXT","rick","HELICÓPTERO BELL • IMAGEM ILUSTRATIVA","Rick Sollo, da dupla Rick e Renner, estava em um helicóptero Bell 430 que seguia de Porto Belo para São Joaquim, em Santa Catarina."),
   ("ANIMATION",0,"MECHANISM","rick","ANIMAÇÃO • ROTA DO VOO","A aeronave perdeu contato durante o trajeto pela Serra Catarinense e as buscas se concentraram na região de Urubici."),
   ("REAL",14,"PROOF","rick","HELICÓPTERO BELL • IMAGEM ILUSTRATIVA","Os destroços foram encontrados no dia seguinte. As cinco pessoas a bordo morreram. Renner não estava no helicóptero."),
   ("ANIMATION",2,"MECHANISM","rick","ANIMAÇÃO • FATO X HIPÓTESE","Até agora, não existe uma causa oficial divulgada. Mau tempo durante as buscas não pode ser tratado automaticamente como causa da queda."),
   ("REAL",28,"CONSEQUENCE","rick","HELICÓPTERO BELL • IMAGEM ILUSTRATIVA","A FAB acionou investigadores do Cenipa e do Seripa Cinco para analisar os destroços e a sequência do voo."),
   ("ANIMATION",4,"MECHANISM","rick","ANIMAÇÃO • INVESTIGAÇÃO","A investigação pode avaliar condições meteorológicas, sistemas da aeronave, operação e fatores humanos antes de apontar conclusões."),
   ("REAL",40,"PROOF","rick","HELICÓPTERO BELL • IMAGEM ILUSTRATIVA","Neste momento, o mais responsável é esperar a investigação. Nossos sentimentos às famílias e aos amigos de Rick e das demais vítimas.")
  ]}
}
