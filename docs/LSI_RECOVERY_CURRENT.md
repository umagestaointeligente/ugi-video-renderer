...
`SECURITY_DEFINER_ACL=PASS_55_ZERO_PUBLIC_ANON_AUTH_EXEC`
...
## 2A. Runtime truth seal — 2026-09-07
...
- SECURITY DEFINER = 55, execute PUBLIC/anon/authenticated = 0, fixed search_path = 55/55;
...
`career-ui-state` V2 / JWT required / control-plane aligned.
